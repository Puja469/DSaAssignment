...
public class MainMenu {
    ...
    public MainMenu() throws SQLException{
        ...
        Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306","root","pass5678@");
        Statement statement = connection.createStatement();

        //Creating Database and table if not exists
        statement.execute("create database if not exists puja_7");
        statement.execute("use puja_7");
        ...
        mainMenuFrame.setTitle("SocialNetworking App");
        ...
        findjobsthroughyour = new JLabel();
        ...
        community = new JLabel("SocialNetworking App");
        community.setFont(new Font("Helvetica",Font.ITALIC,40));
        community.setForeground(new Color(239, 166, 146));
        ...
        loginUsernameLabel.setForeground(new Color(44, 87, 129, 255));
        ...
        loginUsernameTextfield.setForeground(new Color(241, 168, 168, 191));
        ...
        loginButton.setBackground(new Color(10,10,25));
        loginButton.setForeground(new Color(10,102,255));
        ...
        makethemostoutofurprofessionallife = new JLabel("SocialNetworking App");
        ...
        signupButton.setForeground(new Color(10,102,255));
